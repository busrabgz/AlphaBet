...
class Register extends Component {
  ...
  render() {
    ...
    return (<div>
        <NavBar updateType={this.props.updateType} type={this.props.type} id = {this.props.id} isLogged={this.props.userSuccess} userBalance={this.props.balance} alphaCoins = {this.props.alphaCoins}/>
        <h1>Register Page</h1>
