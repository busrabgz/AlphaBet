              ...
              <Table aria-label="customized table">
                <TableBody>
                    <TableRow>
                      ...
                      <TableCell style={{width: '10%'}} align="left"><Button src={likeIcon}>COMMENT</Button></TableCell>
                      <TableCell style={{width: '10%'}} align="left"><Button src={likeIcon}>LIKE</Button></TableCell>
                    </TableRow>
                </TableBody>
              </Table>
              <Table aria-label="customized table">
